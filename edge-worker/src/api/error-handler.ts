...
export function handleError(error: Error, correlationId?: string, logger?: Logger): Response {
...
export function jsonError(status: number, code: string, message: string, correlationId?: string, details?: any): Response {
