...
export interface ILLMPort {
	generateCompletion(request: LLMCompletionRequest, correlationId: string): Promise<LLMCompletionResponse>;

	streamCompletion(request: LLMCompletionRequest): AsyncIterableIterator<{
		delta: string;
		tool_calls?: ToolCall[];
		done: boolean;
	}>;
