...
export class FlightOption {
	...
	private constructor(id: string, segments: FlightSegment[], totalPrice: number, currency: string, bookingUrl?: string) {
	...
	static create(segments: FlightSegment[], totalPrice: number, currency: string, bookingUrl?: string): FlightOption {
		return new FlightOption(crypto.randomUUID(), segments, totalPrice, currency, bookingUrl);
	}

	static reconstitute(id: string, segments: FlightSegment[], totalPrice: number, currency: string, bookingUrl?: string): FlightOption {
